...
if (isset($_POST['idMember'], $_POST['password'], $_POST['name'], $_POST['tempatLahir'], $_POST['tanggalLahir'], $_POST['noTelepon'])) {
    ...
    $query = "UPDATE member SET username='$password', name='$name', tempatLahir='$tempatLahir', tanggalLahir='$tanggalLahir', noTelepon='$noTelepon' WHERE idMember='$idMember'";
